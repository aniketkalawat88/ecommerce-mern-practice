class ErrorHander extends Error {  //jab bhi error aayegi toh ye class call hogi and Error class ke saare properties and methods is class me inherit honge 
...
module.exports = ErrorHander;  // Export the ErrorHandler class so that other modules can use it